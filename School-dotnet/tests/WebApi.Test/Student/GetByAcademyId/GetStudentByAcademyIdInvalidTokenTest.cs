...
{
    public class GetStudentByAcademyIdInvalidTokenTest : SchoolClassFixture
    {
        private const string METHOD = "student/academy";

        public GetStudentByAcademyIdInvalidTokenTest(CustomWebApplicationFactory webApplication) : base(webApplication)
        {
        }
