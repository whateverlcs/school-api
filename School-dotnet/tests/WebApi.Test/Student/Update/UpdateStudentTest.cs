...
{
    public class UpdateStudentTest : SchoolClassFixture
    {
        ...
        public UpdateStudentTest(CustomWebApplicationFactory factory) : base(factory)
        {
        ...
        public async Task Success()
        {
            ...
            var response = await DoPut($"{METHOD}/{_studentId}", request, token);
        ...
        public async Task Error_Student_Name_Empty(string culture)
        {
            ...
            var response = await DoPut($"{METHOD}/{_studentId}", request, token, culture);
