...
{
    public class GetAcademyByIdInvalidTokenTest : SchoolClassFixture
    {
        private const string METHOD = "academy";

        public GetAcademyByIdInvalidTokenTest(CustomWebApplicationFactory webApplication) : base(webApplication)
        {
        }
