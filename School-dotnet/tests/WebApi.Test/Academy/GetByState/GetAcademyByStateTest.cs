...
{
    public class GetAcademyByStateTest : SchoolClassFixture
    {
        ...
        public GetAcademyByStateTest(CustomWebApplicationFactory factory) : base(factory)
        {
            _userIdentifier = factory.GetUserIdentifier();
            _state = factory.GetAcademyState();
        }

        [Fact]
        public async Task Success()
        {
            var request = RequestGetAcademyByStateBuilder.New().WithState(_state).Build();
        ...
        {
            var request = RequestGetAcademyByStateBuilder.New().WithState("NotExists").Build();
