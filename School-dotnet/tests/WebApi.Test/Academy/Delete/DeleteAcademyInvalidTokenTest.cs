...
{
    public class DeleteAcademyInvalidTokenTest : SchoolClassFixture
    {
        private const string METHOD = "academy";

        public DeleteAcademyInvalidTokenTest(CustomWebApplicationFactory webApplication) : base(webApplication)
        {
        }
