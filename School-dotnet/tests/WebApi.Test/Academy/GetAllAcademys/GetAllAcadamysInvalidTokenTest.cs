...
{
    public class GetAllAcadamysInvalidTokenTest : SchoolClassFixture
    {
        private const string METHOD = "academy";

        public GetAllAcadamysInvalidTokenTest(CustomWebApplicationFactory webApplication) : base(webApplication)
        {
        }
