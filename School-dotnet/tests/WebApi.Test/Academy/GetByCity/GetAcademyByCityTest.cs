...
{
    public class GetAcademyByCityTest : SchoolClassFixture
    {
        ...
        public GetAcademyByCityTest(CustomWebApplicationFactory factory) : base(factory)
        {
            _userIdentifier = factory.GetUserIdentifier();
            _city = factory.GetAcademyCity();
        }

        [Fact]
        public async Task Success()
        {
            var request = RequestGetAcademyByCityBuilder.New().WithCity(_city).Build();
        ...
        {
            var request = RequestGetAcademyByCityBuilder.New().WithCity("NotExists").Build();
